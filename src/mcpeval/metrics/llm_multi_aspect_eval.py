...
class MultiAspectLLMJudger:
    ...
    trajectory_prompt_template: Optional[str] = (
        None  # custom trajectory evaluation prompt
    )
    task_completion_prompt_template: Optional[str] = (
        None  # custom task completion evaluation prompt
    )
    model_config: Optional[Dict[str, Any]] = (
        None  # model configuration for OpenAI client
    )
