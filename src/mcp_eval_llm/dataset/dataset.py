...
class Dataset:
        ...
        if data is not None:
            ...
            if data_format is None:
                ...
                try:
                    ...
                    raise ValueError(f"Could not infer data format from extension: {ext}")
            
            self._load_from_file(data_path, data_format)
        else:
            raise ValueError("No data source specified. Provide either data or data_path")
    
    def _load_from_file(self, data_path: Union[str, Path], data_format: DatasetFormat) -> None:
    ...
    def save(self, output_path: Union[str, Path], format: Union[str, DatasetFormat] = DatasetFormat.JSON) -> None:
        """
