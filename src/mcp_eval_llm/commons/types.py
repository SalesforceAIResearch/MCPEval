...
class Task(BaseModel):
    ...
    tools: Optional[List[ToolDefinition]] = Field(None, description="List of tools available for the task")
    tool_calls: Optional[List[ToolCall]] = Field(None, description="Expected tool calls for this task")
    final_response: Optional[str] = Field(None, description="Final response for the task")
    conversation: Optional[List[Message]] = Field(None, description="Conversation history for the task")
    tool_call_results: Optional[List[Union[Tuple[ToolCall, Optional[ToolCallResult]], Tuple[ToolCall, Any], Any]]] = Field(None, description="Results of the tool calls")
