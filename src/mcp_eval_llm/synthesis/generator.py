...
# from mcp_eval_llm.synthesis.scenarios import Scenario, ScenarioLibrary, ScenarioNameDescFormat  # TODO: scenarios module not implemented yet
from mcp_eval_llm.commons.prompts import scenario_generation_system_prompt, scenario_generation_user_prompt
...
class LLMGenerator:
    ...
    def generate_structured_response(self, messages: List[Dict[str, Any]], response_format: Type[BaseModel]) -> BaseModel:
