...
class OpenAIWrapper:
    ...
    def __init__(self, model="gpt-4o", api_key=None, base_url=None, model_config=None, **kwargs):
        from openai import OpenAI
        
        # If model_config is provided, use it for configuration
        if model_config is not None:
            # Extract client-specific parameters
            client_api_key = model_config.get("api_key") or api_key or os.getenv("OPENAI_API_KEY")
