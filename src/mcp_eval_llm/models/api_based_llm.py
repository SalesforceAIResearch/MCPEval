...
class APIBasedLLM(BaseLLM):
    ...
    def __init__(self, name: str = None, config: Dict[str, Any] = None):
        ...
        if not self.api_endpoint:
            raise ValueError("API endpoint is required but not set. Please set the api_endpoint in the model config.")
    ...
    def chat_completion(self, messages: List[Dict[str, Any]], tools: List[Dict[str, Any]] = None, **kwargs) -> Dict[str, Any]:
        """
