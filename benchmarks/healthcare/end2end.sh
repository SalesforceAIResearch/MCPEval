...
mcp-eval analyze --predictions benchmarks/healthcare/results/gpt4o_mix_task_evaluation.json --ground-truth data/healthcare/evaluation_tasks_verified.jsonl --generate-report --report-model gpt-4.1-2025-04-14 --report-output benchmarks/healthcare/results/gpt4o_healthcare_report.md
...
mcp-eval analyze --predictions benchmarks/healthcare/results/gpt4o-mini_mix_task_evaluation.json --ground-truth data/healthcare/evaluation_tasks_verified.jsonl --generate-report --report-model gpt-4.1-2025-04-14 --report-output benchmarks/healthcare/results/gpt4o-mini_healthcare_report.md
...
mcp-eval analyze --predictions benchmarks/healthcare/results/gpt4.1-mini_mix_task_evaluation.json --ground-truth data/healthcare/evaluation_tasks_verified.jsonl --generate-report --report-model gpt-4.1-2025-04-14 --report-output benchmarks/healthcare/results/gpt4.1-mini_healthcare_report.md
...
mcp-eval analyze --predictions benchmarks/healthcare/results/gpt4.1-nano_mix_task_evaluation.json --ground-truth data/healthcare/evaluation_tasks_verified.jsonl --generate-report --report-model gpt-4.1-2025-04-14 --report-output benchmarks/healthcare/results/gpt4.1-nano_healthcare_report.md
...
mcp-eval analyze --predictions benchmarks/healthcare/results/o3_mix_task_evaluation.json --ground-truth data/healthcare/evaluation_tasks_verified.jsonl --generate-report --report-model gpt-4.1-2025-04-14 --report-output benchmarks/healthcare/results/o3_healthcare_report.md
...
mcp-eval analyze --predictions benchmarks/healthcare/results/o3-mini_mix_task_evaluation.json --ground-truth data/healthcare/evaluation_tasks_verified.jsonl --generate-report --report-model gpt-4.1-2025-04-14 --report-output benchmarks/healthcare/results/o3-mini_healthcare_report.md
...
mcp-eval analyze --predictions benchmarks/healthcare/results/o4-mini_mix_task_evaluation.json --ground-truth data/healthcare/evaluation_tasks_verified.jsonl --generate-report --report-model gpt-4.1-2025-04-14 --report-output benchmarks/healthcare/results/o4-mini_healthcare_report.md 