...
mcp-eval judge --input-file benchmarks/sqlite/results/gpt4o_mix_task_evaluation.json --output-dir benchmarks/sqlite/results --model gpt-4o
...
mcp-eval judge --input-file benchmarks/sqlite/results/gpt4.1-mini_mix_task_evaluation.json --output-dir benchmarks/sqlite/results --model gpt-4o
...
mcp-eval judge --input-file benchmarks/sqlite/results/gpt4.1-nano_mix_task_evaluation.json --output-dir benchmarks/sqlite/results --model gpt-4o --resume
...
mcp-eval judge --input-file benchmarks/sqlite/results/gpt4o-mini_mix_task_evaluation.json --output-dir benchmarks/sqlite/results --model gpt-4o
...
# O3
echo "Processing o3..."
mcp-eval judge --input-file benchmarks/sqlite/results/o3_mix_task_evaluation.json --output-dir benchmarks/sqlite/results --model gpt-4o
...
mcp-eval judge --input-file benchmarks/sqlite/results/o3-mini_mix_task_evaluation.json --output-dir benchmarks/sqlite/results --model gpt-4o
...
mcp-eval judge --input-file benchmarks/sqlite/results/o4-mini_mix_task_evaluation.json --output-dir benchmarks/sqlite/results --model gpt-4o
