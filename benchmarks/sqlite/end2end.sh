...
mcp-eval analyze --predictions benchmarks/sqlite/results/gpt4o_mix_task_evaluation.json --ground-truth data/sqlite/evaluation_tasks_verified.jsonl --generate-report --include-charts --report-model gpt-4.1-2025-04-14 --report-output benchmarks/sqlite/report/gpt4o_sqlite_report.md
...
mcp-eval analyze --predictions benchmarks/sqlite/results/gpt4o-mini_mix_task_evaluation.json --ground-truth data/sqlite/evaluation_tasks_verified.jsonl --generate-report --include-charts --report-model gpt-4.1-2025-04-14 --report-output benchmarks/sqlite/report/gpt4o-mini_sqlite_report.md
...
mcp-eval analyze --predictions benchmarks/sqlite/results/gpt4.1-mini_mix_task_evaluation.json --ground-truth data/sqlite/evaluation_tasks_verified.jsonl --generate-report --include-charts --report-model gpt-4.1-2025-04-14 --report-output benchmarks/sqlite/report/gpt4.1-mini_sqlite_report.md
...
mcp-eval analyze --predictions benchmarks/sqlite/results/gpt4.1-nano_mix_task_evaluation.json --ground-truth data/sqlite/evaluation_tasks_verified.jsonl --generate-report --include-charts --report-model gpt-4.1-2025-04-14 --report-output benchmarks/sqlite/report/gpt4.1-nano_sqlite_report.md
...
mcp-eval analyze --predictions benchmarks/sqlite/results/o3_mix_task_evaluation.json --ground-truth data/sqlite/evaluation_tasks_verified.jsonl --generate-report --include-charts --report-model gpt-4.1-2025-04-14 --report-output benchmarks/sqlite/report/o3_sqlite_report.md
...
mcp-eval analyze --predictions benchmarks/sqlite/results/o3-mini_mix_task_evaluation.json --ground-truth data/sqlite/evaluation_tasks_verified.jsonl --generate-report --include-charts --report-model gpt-4.1-2025-04-14 --report-output benchmarks/sqlite/report/o3-mini_sqlite_report.md
...
mcp-eval analyze --predictions benchmarks/sqlite/results/o4-mini_mix_task_evaluation.json --ground-truth data/sqlite/evaluation_tasks_verified.jsonl --generate-report --include-charts --report-model gpt-4.1-2025-04-14 --report-output benchmarks/sqlite/report/o4-mini_sqlite_report.md 